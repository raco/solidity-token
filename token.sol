...
// Comentarios en español e ingles porque me da la gana
...
contract Token {
    ...
    constructor(string memory _name, string memory _symbol, uint _decimals, uint _totalSupply) {
        ...
        // Asignando todo el supply a esta persona que crea el contract
    ...
    function _transfer(address _from, address _to, uint256 _value) internal {
        // me aseguro de que es un address válido, 
        // Nota: el address 0x0 puede ser usado para hacer burn() quema de tokens
